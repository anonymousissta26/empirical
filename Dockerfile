...
# Install Benchmarks
WORKDIR ${BASE_DIR}
RUN git clone https://github.com/anonymousissta26/empirical.git
WORKDIR ${BASE_DIR}/empirical
RUN bash building_target.sh all

# Load Dataset
WORKDIR ${BASE_DIR}/empirical
RUN wget https://github.com/anonymousissta26/empirical/releases/download/experiments/dataset.tar.xz
RUN tar -xf dataset.tar.xz
